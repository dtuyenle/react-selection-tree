...
export default class InputBox extends Component {
  ...
  getCheckBox(checkboxNode, filterName) {
    const {color, selectcolor, multipleSelect, direction, excludeSelect, toolTipPlacement} = this.props;
    ...
    return multipleSelect ? <CheckBox color={selectcolor} style={style}>{input}{label}</CheckBox> : <Radio color={selectcolor} style={style}>{input}{label}</Radio>;
  }
  ...
  render() {
    const {filter, color, updateCustom, name, search, clearall, infinite} = this.props;
