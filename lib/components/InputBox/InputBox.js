...
var Chevron = _styledComponents2.default.i(_templateObject, function (props) {
  return props.color;
});

var CheckboxContainer = _styledComponents2.default.div(_templateObject2);

var CheckboxCustom = _styledComponents2.default.div(_templateObject3);

var CheckboxLabel = _styledComponents2.default.label(_templateObject4);
...
var InputBox = function (_Component) {
  ...
  _createClass(InputBox, [{
    ...
    key: 'getCheckBoxesList',
    value: function getCheckBoxesList() {
      var _this2 = this;
    ...
    value: function getCheckBox(checkboxNode, filterName) {
      ...
      var label = _react2.default.createElement(
        ...
        checkboxNode.children && checkboxNode.children !== null && Object.keys(checkboxNode.children).length !== 0 && _react2.default.createElement(
          ...
          _react2.default.createElement(Chevron, { color: color })
        )
      );
    ...
    value: function search(event) {
      ...
      if (event.target.value.length < 3) {
        ...
        this.setState({ search_value: event.target.value }, function () {
          _this5.props.searchFilter(_this5.state.search_value);
        });
      }
    }
  }, {
    ...
    value: function handleInnerLevelClick(filter) {
      ...
      this.setState({
        ...
        _this6.props.updateFilter(filter);
      });
    }
  }, {
    key: 'uncheckAll',
    value: function uncheckAll() {
      ...
      this.setState({
        ...
        _this7.props.uncheckAll();
        if (_this7.refs.list) {
          _this7.refs.list.forceUpdateGrid();
        }
      });
    }
  }, {
    ...
    value: function handleCheckBoxClick(filter, event) {
      var _props5 = this.props,
          name = _props5.name,
          checkFilter = _props5.checkFilter;
    ...
    value: function render() {
      var _props6 = this.props,
          ...
          color = _props6.color,
          updateCustom = _props6.updateCustom,
          name = _props6.name,
          search = _props6.search,
          clearall = _props6.clearall,
...
InputBox.propTypes = {
  ...
  selectcolor: _propTypes2.default.string,
